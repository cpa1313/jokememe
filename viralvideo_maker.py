...
JOKE_THEMES = [
    ...
    # Format A: Kinky/Flirty wordplay
    {
        "style": "kinky",
        "prompt": (
            "You write viral flirty-kinky meme captions for a Filipino humor page on Facebook Reels.\n"
            "Write in TAGLISH — casual mix of simple Tagalog and English, like how Filipinos text.\n"
            "Use only simple everyday words. No deep Tagalog.\n\n"
            "THE STYLE: Short 1-2 lines. Uses a word or phrase with a double meaning.\n"
            "Sounds like a normal sentence at first — but when you think about it, everyone gets the kinky meaning.\n"
            "The joke lives in the WORDPLAY. No need for a setup or story. Just one clever line.\n\n"
            "THESE ARE THE EXACT EXAMPLES TO COPY THE STYLE FROM:\n"
            "1. sagad na sagad na pasensya ko, sana ibang sagad naman maranasan ko\n"
            "   (sagad = maxed out / also has sexual implication — same word, two meanings)\n\n"
            "2. Pwede moko sandalan pag may problema ka, pwede ka rin pumatong para malutas na\n"
            "   (pumatong = to lean on / also means to get on top — double meaning)\n\n"
            "3. Ikakagalit ba ng magic sarap kung ang tunay na sarap sakin mo lang malalasap\n"
            "   (sarap = delicious / also means pleasure — wordplay)\n\n"
            "4. Ang galing ko daw manamit, ang hindi nila alam mas magaling ako kapag walang damit\n"
            "   (manamit = dressed well / twist: better without clothes)\n\n"
            "5. hindi lahat ng tumatayo may paa, bakit yung ano basta nakalimutan ko\n"
            "   (tumatayo = stands up / obvious double meaning, trails off with nakalimutan ko)\n\n"
            "6. hindi kita pinipilit magstay kaya kung aalis ka, sama ako\n"
            "   (flirty twist — not forcing you to stay but will follow you)\n\n"
            "7. next time na ako iinom kapag nasa bibig mo na yung chaser\n"
            "   (bibig = mouth / double meaning with chaser)\n\n"
            "8. nakapag stay nga ako sa bahay eh, sa buhay mo pa kaya\n"
            "   (staying in your life = flirty implication)\n\n"
            "9. payo ko sayo ako ang para sayo\n"
            "   (short, confident, flirty — no wordplay needed, just bold)\n\n"
            "10. mahalin mo lagi sarili mo tapos idamay mo na rin ako\n"
            "    (self-love but include me — sweet and flirty)\n\n"
            "11. lagi nalang ako kinakain ng kalungkutan, ganon na ba ako kasarap\n"
            "    (kinakain = consumed by / also eaten — double meaning)\n\n"
            "12. crush palang kita loyal nako\n"
            "    (short punchy — just a fact, no explanation needed)\n\n"
            "HOW TO WRITE A NEW ONE:\n"
            "- Pick a Filipino word that has an innocent meaning AND a flirty/sexual second meaning\n"
            "- OR make a short bold flirty statement with a twist at the end\n"
            "- Keep it 1-2 lines MAX\n"
            "- Never explain the joke — the reader figures it out\n"
            "- Must feel natural, like something you would actually text someone\n\n"
            "BAD EXAMPLES — do NOT write like these:\n"
            "- Gusto ko sumama sa night swimming mo tas kami-kami lang. (too long, setup style, not wordplay)\n"
            "- Gusto ko tumulong sa yoga mo pag stretch tayo. (no double meaning, just nonsense)\n\n"
            "Write ONE new joke in this exact style. Max 20 words. Output ONLY the joke, no quotes, no explanation."
        ),
    },
]
