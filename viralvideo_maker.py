...
JOKE_THEMES = [

    {
        "style": "kinky",
        "prompt": (
            "You write viral flirty-kinky one-liners for a Filipino humor page on Facebook Reels.\n"
            "Write in TAGLISH. Simple words only — no deep Tagalog.\n\n"
            "THE SECRET: Use ONE Tagalog word or phrase that has BOTH an innocent meaning AND a sexual/flirty double meaning.\n"
            "The whole joke is ONE connected thought. The SUBJECT must stay consistent from start to finish — never flip who is doing what.\n\n"
            "=== CRITICAL GRAMMAR RULE ===\n"
            "Before writing, decide: WHO is the subject? WHO is the object?\n"
            "Example of WRONG logic: lagi kitang inuubos (I consume you) + siguro sarap talaga AKO (I am delicious) — WRONG! If I consume YOU, then YOU are the delicious one, not me.\n"
            "Example of CORRECT logic A: lagi mo AKONG inuubos (you consume me) + siguro sarap talaga AKO — CORRECT! You consume me = I must be delicious.\n"
            "Example of CORRECT logic B: lagi KITANG inuubos (I consume you) + ang sarap mo kasi / ang sarap mo talaga eh — CORRECT and NATURAL sounding!\n\n"
            "=== MASTER EXAMPLES — all have consistent subject/object ===\n"
            "- lagi mo akong inuubos, ang sarap mo kasi eh\n"
            "  (you consume me = I must be delicious — CONSISTENT)\n\n"
            "- sagad na sagad na pasensya ko, sana ibang sagad naman maranasan ko\n"
            "  (I = subject throughout, talks about MY experience — CONSISTENT)\n\n"
            "- hindi lahat ng tumatayo may paa, bakit yung ano basta nakalimutan ko\n"
            "  (general statement then trails off — no subject flip)\n\n"
            "- Ang galing ko daw manamit, ang hindi nila alam mas magaling ako kapag walang damit\n"
            "  (I = subject throughout — CONSISTENT)\n\n"
            "- lagi nalang ako kinakain ng kalungkutan, ganon na ba ako kasarap\n"
            "  (sadness consumes me = I must be delicious — CONSISTENT)\n\n"
            "- next time na ako iinom kapag nasa bibig mo na yung chaser\n"
            "  (you = the one with chaser in mouth — CONSISTENT double meaning)\n\n"
            "=== THE RULES ===\n"
            "1. Pick ONE word with double meaning: tumatayo, sagad, inuubos, kinakain, sarap, pumatong, bibig, hubad, hawak, tigas, init, basa, sikip, lalim, taas, haba\n"
            "2. Decide WHO is subject and WHO is object BEFORE writing\n"
            "3. Keep subject/object CONSISTENT the whole sentence — never flip\n"
            "4. Must flow as ONE natural connected thought\n"
            "5. Max 15 words\n"
            "6. Confident tone — never explain the joke\n\n"
            "=== WHAT NOT TO DO ===\n"
            "- Do NOT flip the subject mid-sentence\n"
            "- Do NOT write a story or setup (no swimming, no camping)\n"
            "- Do NOT use two unrelated ideas\n\n"
            "NATURAL TAGALOG ENDINGS — use these instead of stiff phrasing:\n""- ang sarap mo kasi / ang sarap mo talaga eh (NOT: sarap talaga ikaw)\n""- ang galing mo eh / ang galing mo talaga (NOT: galing talaga ikaw)\n""- ang init mo kasi / ang init mo talaga (NOT: mainit talaga ikaw)\n""- ganon ka kasarap / ganon ka kagaling (natural Filipino way)\n""- kasi naman ikaw eh / eh kasi ikaw (trailing off naturally)\n""Rule: always phrase endings the way a Filipino would actually text it — never stiff or literal.\n\n""Write ONE new joke following all rules. Output ONLY the joke, nothing else."
        ),
    },
]
