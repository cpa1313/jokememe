...
JOKE_THEMES = [
    ...
    # Format A: Kinky/Flirty
    {
        "style": "kinky",
        "prompt": (
            "You write viral flirty meme captions for a Filipino humor page on Facebook Reels.\n"
            "Write in TAGLISH — casual mix of simple Tagalog and English, like how Filipinos text.\n"
            "Use only simple everyday words. If a Tagalog word is uncommon, use English instead.\n\n"
            "THE JOKE FORMULA — follow this exactly:\n"
            "Step 1: Suggest doing something together that sounds totally normal and innocent.\n"
            "Step 2: Add a detail that makes it clear you will be ALONE together.\n"
            "Step 3: End with something that trails off OR implies what will really happen — but NEVER say it directly.\n\n"
            "The reader must connect the dots themselves. The joke only works if it is NOT explained.\n\n"
            "PERFECT EXAMPLE — study this carefully:\n"
            "Gusto ko sumama sa night swimming mo, tas mawawala tayong dalawa sa eksena.\n"
            "Why it works: Night swimming = innocent. Mawawala sa eksena = everyone knows what happens next. Never stated directly.\n\n"
            "MORE GOOD EXAMPLES — all follow the same formula:\n"
            "- Sana mag-camp tayo, wala signal, wala ibang tao. Kami-kami lang, malamig pa.\n"
            "- Gusto ko manood ng movie sa bahay mo, yung gabi, yung wala nang ibang tao sa bahay.\n"
            "- Late night drive tayo, walang destination, basta ikaw at ako lang sa loob ng kotse.\n"
            "- Gusto ko matuto ng massage, pwede ka bang maging practice ko? Sa bahay mo, sana walang istorbo.\n"
            "- Sabi mo gusto mo ng stargazing. Alam ko magandang spot. Malayo sa tao. Kami-kami lang.\n\n"
            "WHY THESE WORK: Each one has (1) innocent activity, (2) alone together detail, (3) implied ending.\n\n"
            "BAD EXAMPLES — do NOT write like these:\n"
            "- Gusto ko tumulong sa yoga mo, pag stretch tayo magkasama. (NO — yoga has no alone/private implication, punchline is weak)\n"
            "- Gusto kitang halikan. (NO — too direct, not funny)\n"
            "- Magdate tayo. (NO — too boring, zero double meaning)\n"
            "- Gusto ko ikaw. (NO — no setup, no innocent cover story)\n\n"
            "CHECKLIST before writing — your joke must have ALL THREE:\n"
            "[ ] An innocent-sounding activity (swimming, driving, cooking, watching movie, stargazing, etc.)\n"
            "[ ] A detail that means you will be alone together (wala ibang tao, gabi, malayo sa lahat, kami-kami lang)\n"
            "[ ] An ending that trails off or implies what really happens — never say it explicitly\n\n"
            "Write ONE new joke following this formula. Max 25 words. Output ONLY the joke, no quotes, no explanation."
        ),
    },
]
